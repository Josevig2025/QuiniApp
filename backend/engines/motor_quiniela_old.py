...
class MotorQuiniela:
    ...
    def _indices_por_dia(
        ...
        """
        Devuelve el conjunto de índices (dentro del rango) que corresponden
        a los días seleccionados. Si no hay filtro, devuelve None.
        """
    ...
    def ranking(
        ...
        """
        idx_min, idx_max = self._resolver_rango(idx_min, idx_max)
        indices_dia = self._indices_por_dia(idx_min, idx_max, dia_semana, dia_mes)
        d = self._dic(cifras)
        resultados = []
